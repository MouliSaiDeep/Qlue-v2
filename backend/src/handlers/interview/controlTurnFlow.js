...
const VALID_TRANSITIONS = {
    ...
    // Silence retry logic cycles USER_RESPONDING -> AI_SPEAKING temporarily
    [INTERVIEW_STATES.USER_RESPONDING]: [INTERVIEW_STATES.PROCESSING_RESPONSE, INTERVIEW_STATES.AI_SPEAKING, INTERVIEW_STATES.GENERATING_FEEDBACK, INTERVIEW_STATES.ERROR], 
